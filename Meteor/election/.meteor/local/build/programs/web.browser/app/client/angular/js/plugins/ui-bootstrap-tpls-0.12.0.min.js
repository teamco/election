...
/////////////////////////////////////////////////////////////////////////
//                                                                     //
// client/angular/js/plugins/ui-bootstrap-tpls-0.12.0.min.js           //
//                                                                     //
/////////////////////////////////////////////////////////////////////////
                                                                       //
/*                                                                     //
...
angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdown", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.tpls", ["template/accordion/accordion-group.html", "template/accordion/accordion.html", "template/alert/alert.html", "template/carousel/carousel.html", "template/carousel/slide.html", "template/datepicker/datepicker.html", "template/datepicker/day.html", "template/datepicker/month.html", "template/datepicker/popup.html", "template/datepicker/year.html", "template/modal/backdrop.html", "template/modal/window.html", "template/pagination/pager.html", "template/pagination/pagination.html", "template/tooltip/tooltip-html-unsafe-popup.html", "template/tooltip/tooltip-popup.html", "template/popover/popover.html", "template/progressbar/bar.html", "template/progressbar/progress.html", "template/progressbar/progressbar.html", "template/rating/rating.html", "template/tabs/tab.html", "template/tabs/tabset.html", "template/timepicker/timepicker.html", "template/typeahead/typeahead-match.html", "template/typeahead/typeahead-popup.html"]), angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope", function (a, b, c) {
  ...
  return { link: function (b, c, d) {                                  // 8
      function e(b) {                                                  // 8
        ...
        if (k) k = !1, i(), c.css({ height: 0 });else {                // 8
          c.css({ height: c[0].scrollHeight + "px" });{                // 8
            c[0].offsetWidth;                                          // 8
          }c.removeClass("collapse in").addClass("collapsing"), e({ height: 0 }).then(i);
        }                                                              //
      }function i() {                                                  //
        c.removeClass("collapsing"), c.addClass("collapse");           // 8
      }var j,                                                          //
  ...
  return { require: "^accordion", restrict: "EA", transclude: !0, replace: !0, templateUrl: "template/accordion/accordion-group.html", scope: { heading: "@", isOpen: "=?", isDisabled: "=?" }, controller: function () {
      this.setHeading = function (a) {                                 // 8
        this.heading = a;                                              // 8
      };                                                               //
    }, link: function (a, b, c, d) {                                   //
      d.addGroup(a), a.$watch("isOpen", function (b) {                 // 8
        b && d.closeOthers(a);                                         // 8
      }), a.toggleOpen = function () {                                 //
        a.isDisabled || (a.isOpen = !a.isOpen);                        // 8
      };                                                               //
    } };                                                               //
}).directive("accordionHeading", function () {                         //
  return { restrict: "EA", transclude: !0, template: "", replace: !0, require: "^accordionGroup", link: function (a, b, c, d, e) {
      d.setHeading(e(a, function () {}));                              // 8
    } };                                                               //
}).directive("accordionTransclude", function () {                      //
  return { require: "^accordionGroup", link: function (a, b, c, d) {   // 8
      a.$watch(function () {                                           // 8
        return d[c.accordionTransclude];                               // 8
      }, function (a) {                                                //
        a && (b.html(""), b.append(a));                                // 8
      });                                                              //
    } };                                                               //
}), angular.module("ui.bootstrap.alert", []).controller("AlertController", ["$scope", "$attrs", function (a, b) {
  a.closeable = "close" in b, this.close = a.close;                    // 8
  ...
  return { require: "alert", link: function (b, c, d, e) {             // 8
      a(function () {                                                  // 8
        e.close();                                                     // 8
      }, parseInt(d.dismissOnTimeout, 10));                            //
    } };                                                               //
}]), angular.module("ui.bootstrap.bindHtml", []).directive("bindHtmlUnsafe", function () {
  return function (a, b, c) {                                          // 8
  ...
  return { require: ["btnCheckbox", "ngModel"], controller: "ButtonsController", link: function (a, b, c, d) {
      function e() {                                                   // 8
        return g(c.btnCheckboxTrue, !0);                               // 8
      }function f() {                                                  //
        return g(c.btnCheckboxFalse, !1);                              // 8
      }function g(b, c) {                                              //
        var d = a.$eval(b);return angular.isDefined(d) ? d : c;        // 8
      }var h = d[0],                                                   //
  ...
  function e() {                                                       // 8
    f();var b = +a.interval;!isNaN(b) && b > 0 && (h = c(g, b));       // 8
  }function f() {                                                      //
    h && (c.cancel(h), h = null);                                      // 8
  }function g() {                                                      //
    ...
    function g() {                                                     // 8
      if (!m) {                                                        // 8
        if (j.currentSlide && angular.isString(f) && !a.noTransition && c.$element) {
          c.$element.addClass(f);{                                     // 8
            c.$element[0].offsetWidth;                                 // 8
            ...
            a.$currentTransition.then(function () {                    // 8
              h(b, c);                                                 // 8
            }, function () {                                           //
              h(b, c);                                                 // 8
            });                                                        //
  ...
  return { require: "^carousel", restrict: "EA", transclude: !0, replace: !0, templateUrl: "template/carousel/slide.html", scope: { active: "=?" }, link: function (a, b, c, d) {
      d.addSlide(a, b), a.$on("$destroy", function () {                // 8
        d.removeSlide(a);                                              // 8
  ...
  function c(a) {                                                      // 8
    ...
    return 1 === b && c > 28 ? 29 === c && (a % 4 === 0 && a % 100 !== 0 || a % 400 === 0) : 3 === b || 5 === b || 8 === b || 10 === b ? 31 > c : !0;
        ...
        this.month = a.DATETIME_FORMATS.MONTH.indexOf(b);              // 8
      } }, MMM: { regex: a.DATETIME_FORMATS.SHORTMONTH.join("|"), apply: function (b) {
        this.month = a.DATETIME_FORMATS.SHORTMONTH.indexOf(b);         // 8
    ...
    if (!angular.isString(b) || !e) return b;e = a.DATETIME_FORMATS[e] || e, this.parsers[e] || (this.parsers[e] = c(e));var f = this.parsers[e],
      ...
      for (var j, k = { year: 1900, month: 0, date: 1, hours: 0 }, l = 1, m = i.length; m > l; l++) {
        var n = h[l - 1];n.apply && n.apply.call(k, i[l]);             // 8
  ...
  function c(a, c) {                                                   // 8
    ...
    for (var c = a[0], e = b.offsetParent || c; e && e !== c && d(e);) e = e.offsetParent;return e || c;
      ...
      var e,                                                           // 8
          ...
          m = { center: function () {                                  //
          return e.top + e.height / 2 - g / 2;                         // 8
        }, top: function () {                                          //
          return e.top;                                                // 8
        }, bottom: function () {                                       //
          return e.top + e.height;                                     // 8
        } };switch (j) {case "right":                                  //
          h = { top: m[k](), left: l[j]() };break;case "left":         // 8
          h = { top: m[k](), left: e.left - f };break;case "bottom":   // 8
          h = { top: m[j](), left: l[k]() };break;default:             // 8
          h = { top: e.top - g, left: l[k]() };}return h;              // 8
    } };                                                               //
  ...
  var i = this,                                                        // 8
    ...
    b[d] ? a.$parent.$watch(c(b[d]), function (a) {                    // 8
      i[d] = a ? new Date(a) : null, i.refreshView();                  // 8
    ...
    j = a, j.$render = function () {                                   // 8
      i.render();                                                      // 8
    };                                                                 //
  }, this.render = function () {                                       //
    if (j.$modelValue) {                                               // 8
      var a = new Date(j.$modelValue),                                 // 8
    ...
    for (var c = []; a.length > 0;) c.push(a.splice(0, b));return c;   // 8
  }, a.select = function (b) {                                         //
    if (a.datepickerMode === i.minMode) {                              // 8
    ...
    var b = i.activeDate.getFullYear() + a * (i.step.years || 0),      // 8
  ...
  return { restrict: "EA", replace: !0, templateUrl: "template/datepicker/day.html", require: "^datepicker", link: function (b, c, d, e) {
      function f(a, b) {                                               // 8
        ...
        var c = e.activeDate.getFullYear(),                            // 8
  ...
  return { restrict: "EA", replace: !0, templateUrl: "template/datepicker/year.html", require: "^datepicker", link: function (a, b, c, d) {
      function e(a) {                                                  // 8
        return parseInt((a - 1) / f, 10) * f + 1;                      // 8
        ...
        return a.getFullYear() - b.getFullYear();                      // 8
  ...
  return { restrict: "EA", require: "ngModel", scope: { isOpen: "=?", currentText: "@", clearText: "@", closeText: "@", dateDisabled: "&" }, link: function (h, i, j, k) {
      function l(a) {                                                  // 8
        return a.replace(/([A-Z])/g, function (a) {                    // 8
          return "-" + a.toLowerCase();                                // 8
        });                                                            //
      }function m(a) {                                                 //
        if (a) {                                                       // 8
        ...
        return h[a + "Text"] || g[a + "Text"];                         // 8
      }, j.$observe("datepickerPopup", function (a) {                  //
        n = a || g.datepickerPopup, k.$render();                       // 8
        ...
        if (j[a]) {                                                    // 8
          var c = b(j[a]);if ((h.$parent.$watch(c, function (b) {      // 8
            h.watchData[a] = b;                                        // 8
  ...
  var b = null;this.open = function (e) {                              // 8
    ...
    if (b) {                                                           // 8
      ...
      d = function (a) {                                               //
    27 === a.which && (b.focusToggleElement(), c());                   // 8
  };                                                                   //
  ...
  var g,                                                               // 8
    ...
    return i.isOpen = arguments.length ? !!a : !i.isOpen;              // 8
  }, this.isOpen = function () {                                       //
    return i.isOpen;                                                   // 8
  }, i.getToggleElement = function () {                                //
    return h.toggleElement;                                            // 8
  }, i.focusToggleElement = function () {                              //
    h.toggleElement && h.toggleElement[0].focus();                     // 8
  ...
  return { require: "?^dropdown", link: function (a, b, c, d) {        // 8
      if (d) {                                                         // 8
        d.toggleElement = b;var e = function (e) {                     // 8
          e.preventDefault(), b.hasClass("disabled") || c.disabled || a.$apply(function () {
            d.toggle();                                                // 8
          });                                                          //
        };b.bind("click", e), b.attr({ "aria-haspopup": !0, "aria-expanded": !1 }), a.$watch(d.isOpen, function (a) {
          b.attr("aria-expanded", !!a);                                // 8
        }), a.$on("$destroy", function () {                            //
          b.unbind("click", e);                                        // 8
        });                                                            //
      }                                                                //
  ...
  return { restrict: "EA", scope: { index: "@", animate: "=" }, replace: !0, transclude: !0, templateUrl: function (a, b) {
      return b.templateUrl || "template/modal/window.html";            // 8
    }, link: function (c, d, e) {                                      //
  ...
  return { link: function (a, b, c, d, e) {                            // 8
      e(a.$parent, function (a) {                                      // 8
        b.empty(), b.append(a);                                        // 8
      });                                                              //
    } };                                                               //
  ...
  function g() {                                                       // 8
    ...
    var b = c.find("body").eq(0),                                      // 8
        d = n.get(a).value;n.remove(a), j(d.modalDomEl, d.modalScope, 300, function () {
      d.modalScope.$destroy(), b.toggleClass(m, n.length() > 0), i();  // 8
    });                                                                //
  }function i() {                                                      //
    if (k && -1 == g()) {                                              // 8
      var a = l;j(k, l, 150, function () {                             // 8
        a.$destroy(), a = null;                                        // 8
      }), k = void 0, l = void 0;                                      //
    }                                                                  //
  }function j(c, d, e, f) {                                            //
    function g() {                                                     // 8
      g.done || (g.done = !0, c.remove(), f && f());                   // 8
    }d.animate = !1;var h = a.transitionEndEventName;if (h) {          //
      var i = b(g, e);c.bind(h, function () {                          // 8
        b.cancel(i), g(), d.$apply();                                  // 8
      });                                                              //
    } else b(g);                                                       //
  }var k,                                                              //
      l,                                                               //
    ...
    var b;27 === a.which && (b = n.top(), b && b.value.keyboard && (a.preventDefault(), e.$apply(function () {
      o.dismiss(b.key, "escape key press");                            // 8
    })));                                                              //
  }), o.open = function (a, b) {                                       //
    ...
    var c = n.get(a);c && (c.value.deferred.resolve(b), h(a));         // 8
  }, o.dismiss = function (a, b) {                                     //
    var c = n.get(a);c && (c.value.deferred.reject(b), h(a));          // 8
  ...
  var a = { options: { backdrop: !0, keyboard: !0 }, $get: ["$injector", "$rootScope", "$q", "$http", "$templateCache", "$controller", "$modalStack", function (b, c, d, e, f, g, h) {
      function i(a) {                                                  // 8
        ...
        var c = [];return (angular.forEach(a, function (a) {           // 8
  ...
  var d = this,                                                        // 8
    ...
    e = f, this.config = g, e.$render = function () {                  // 8
      d.render();                                                      // 8
    ...
    a.page = parseInt(e.$viewValue, 10) || 1;                          // 8
  }, a.selectPage = function (b) {                                     //
    a.page !== b && b > 0 && b <= a.totalPages && (e.$setViewValue(b), e.$render());
  }, a.getText = function (b) {                                        //
    return a[b + "Text"] || d.config[b + "Text"];                      // 8
  }, a.noPrevious = function () {                                      //
    return 1 === a.page;                                               // 8
  }, a.noNext = function () {                                          //
    return a.page === a.totalPages;                                    // 8
  }, a.$watch("totalItems", function () {                              //
    a.totalPages = d.calculateTotalPages();                            // 8
  }), a.$watch("totalPages", function (b) {                            //
    f(a.$parent, b), a.page > b ? a.selectPage(b) : e.$render();       // 8
  });                                                                  //
  ...
  return { restrict: "EA", scope: { totalItems: "=", firstText: "@", previousText: "@", nextText: "@", lastText: "@" }, require: ["pagination", "?ngModel"], controller: "PaginationController", templateUrl: "template/pagination/pagination.html", replace: !0, link: function (c, d, e, f) {
      function g(a, b, c) {                                            // 8
        return { number: a, text: b, active: c };                      // 8
      }function h(a, b) {                                              //
        var c = [],                                                    // 8
            d = 1,                                                     //
            e = b,                                                     //
          ...
          var i = g(h, h, h === a);c.push(i);                          // 8
        }if (f && !l) {                                                //
          if (d > 1) {                                                 // 8
            var j = g(d - 1, "...", !1);c.unshift(j);                  // 8
          }if (b > e) {                                                //
            var m = g(e + 1, "...", !1);c.push(m);                     // 8
          }                                                            //
        }return c;                                                     //
      }var i = f[0],                                                   //
          j = f[1];if (j) {                                            //
    ...
    return function (e, k, l) {                                        // 9
      function m(a) {                                                  // 9
        var b = a || n.trigger || l,                                   // 9
          ...
          var a = f(r);return function (b, c, d) {                     // 9
            function f() {                                             // 9
              D.isOpen ? l() : j();                                    // 9
            }function j() {                                            //
              ...
              w && r(), x = D.$new(), w = a(x, angular.noop);          // 9
            }function r() {                                            //
              ...
              D.content = a, !a && D.isOpen && p();                    // 9
            }), d.$observe(k + "Title", function (a) {                 //
              D.title = a;                                             // 9
            });var F = function () {                                   //
              c.unbind(B.show, j), c.unbind(B.hide, l);                // 9
              ...
              g.cancel(y), g.cancel(z), F(), r(), D = null;            // 9
            });                                                        //
          };                                                           //
        } };                                                           //
    };                                                                 //
  ...
  return a("tooltip", "tooltip", "mouseenter");                        // 9
  ...
  return a("tooltipHtmlUnsafe", "tooltip", "mouseenter");              // 9
  ...
  return a("popover", "popover", "click");                             // 9
  ...
  var d = this,                                                        // 9
    ...
    e || c.css({ transition: "none" }), this.bars.push(b), b.$watch("value", function (c) {
      b.percent = +(100 * c / a.max).toFixed(2);                       // 9
    }), b.$on("$destroy", function () {                                //
      c = null, d.removeBar(b);                                        // 9
    });                                                                //
  }, this.removeBar = function (a) {                                   //
    this.bars.splice(this.bars.indexOf(a), 1);                         // 9
  };                                                                   //
  ...
  return { restrict: "EA", replace: !0, transclude: !0, controller: "ProgressController", scope: { value: "=", type: "@" }, templateUrl: "template/progressbar/progressbar.html", link: function (a, b, c, d) {
      d.addBar(a, angular.element(b.children()[0]));                   // 9
    } };                                                               //
  ...
  var d = { $setViewValue: angular.noop };this.init = function (e) {   // 9
    ...
    a.readonly || (a.value = b), a.onHover({ value: b });              // 9
  }, a.reset = function () {                                           //
    a.value = d.$viewValue, a.onLeave();                               // 9
  }, a.onKeydown = function (b) {                                      //
    /(37|38|39|40)/.test(b.which) && (b.preventDefault(), b.stopPropagation(), a.rate(a.value + (38 === b.which || 39 === b.which ? 1 : -1)));
  }, this.render = function () {                                       //
    a.value = d.$viewValue;                                            // 9
  };                                                                   //
  ...
  var b = this,                                                        // 9
    ...
    angular.forEach(c, function (b) {                                  // 9
      b.active && b !== a && (b.active = !1, b.onDeselect());          // 9
    }), a.active = !0, a.onSelect();                                   //
  }, b.addTab = function (a) {                                         //
    c.push(a), 1 === c.length ? a.active = !0 : a.active && b.select(a);
  }, b.removeTab = function (a) {                                      //
    var e = c.indexOf(a);if (a.active && c.length > 1 && !d) {         // 9
      var f = e == c.length - 1 ? e - 1 : e + 1;b.select(c[f]);        // 9
    }c.splice(e, 1);                                                   //
  ...
  return { require: "^tabset", restrict: "EA", replace: !0, templateUrl: "template/tabs/tab.html", transclude: !0, scope: { active: "=?", heading: "@", onSelect: "&select", onDeselect: "&deselect" }, controller: function () {}, compile: function (b, c, d) {
      return function (b, c, e, f) {                                   // 9
        b.$watch("active", function (a) {                              // 9
          a && f.select(b);                                            // 9
        }), b.disabled = !1, e.disabled && b.$parent.$watch(a(e.disabled), function (a) {
          b.disabled = !!a;                                            // 9
        }), b.select = function () {                                   //
          b.disabled || (b.active = !0);                               // 9
  ...
  return { restrict: "A", require: "^tab", link: function (a, b) {     // 9
      a.$watch("headingElement", function (a) {                        // 9
        a && (b.html(""), b.append(a));                                // 9
      });                                                              //
    } };                                                               //
  ...
  function a(a) {                                                      // 9
    return a.tagName && (a.hasAttribute("tab-heading") || a.hasAttribute("data-tab-heading") || "tab-heading" === a.tagName.toLowerCase() || "data-tab-heading" === a.tagName.toLowerCase());
      ...
      var e = b.$eval(d.tabContentTransclude);e.$transcludeFn(e.$parent, function (b) {
        angular.forEach(b, function (b) {                              // 9
          a(b) ? e.headingElement = b : c.append(b);                   // 9
        });                                                            //
      });                                                              //
    } };                                                               //
  ...
  function g() {                                                       // 9
    ...
    k(), o.$setViewValue(new Date(n)), l(a);                           // 9
  }function k() {                                                      //
    ...
    o = c, o.$render = this.render;var e = d.eq(0),                    // 9
        g = d.eq(1),                                                   //
    ...
    if ((a.showMeridian = !!b, o.$error.time)) {                       // 9
      var c = g(),                                                     // 9
    ...
    if (a.readonlyInput) return (a.updateHours = angular.noop, void (a.updateMinutes = angular.noop));var d = function (b, c) {
      ...
      !a.invalidHours && a.hours < 10 && a.$apply(function () {        // 9
        a.hours = i(a.hours);                                          // 9
      });                                                              //
    }), a.updateMinutes = function () {                                //
      var a = h();angular.isDefined(a) ? (n.setMinutes(a), j("m")) : d(void 0, !0);
    }, c.bind("blur", function () {                                    //
      !a.invalidMinutes && a.minutes < 10 && a.$apply(function () {    // 9
        a.minutes = i(a.minutes);                                      // 9
      });                                                              //
    });                                                                //
  }, this.render = function () {                                       //
  ...
  var h = [9, 13, 27, 38, 40];return { require: "ngModel", link: function (i, j, k, l) {
      var m,                                                           // 9
        ...
        var b = { $viewValue: a };q(i, !0), c.when(w.source(i, b)).then(function (c) {
          var d = a === l.$viewValue;if (d && m) if (c.length > 0) {   // 9
  ...
  return { restrict: "EA", scope: { matches: "=", query: "=", active: "=", position: "=", select: "&" }, replace: !0, templateUrl: "template/typeahead/typeahead-popup.html", link: function (a, b, c) {
      a.templateUrl = c.templateUrl, a.isOpen = function () {          // 9
        return a.matches.length > 0;                                   // 9
      }, a.isActive = function (b) {                                   //
        return a.active == b;                                          // 9
      }, a.selectActive = function (b) {                               //
        a.active = b;                                                  // 9
      }, a.selectMatch = function (b) {                                //
        a.select({ activeIdx: b });                                    // 9
      };                                                               //
    } };                                                               //
  ...
  return { restrict: "EA", scope: { index: "=", match: "=", query: "=" }, link: function (e, f, g) {
      var h = d(g.templateUrl)(e.$parent) || "template/typeahead/typeahead-match.html";a.get(h, { cache: b }).success(function (a) {
        f.replaceWith(c(a.trim())(e));                                 // 9
      });                                                              //
    } };                                                               //
}]).filter("typeaheadHighlight", function () {                         //
  function a(a) {                                                      // 9
    return a.replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1");                // 9
  }return function (b, c) {                                            //
