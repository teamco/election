 ...
 */                                                                    //
                                                                       //
!(function (a) {                                                       // 10
  "use strict";function b() {                                          // 10
    var a = document.createElement("mm"),                              // 10
    ...
    return this.each(function () {                                     // 10
      var c = a(this),                                                 // 10
          d = c.data("mm"),                                            //
          f = a.extend({}, e.DEFAULTS, c.data(), "object" == typeof b && b);d || c.data("mm", d = new e(this, f)), "string" == typeof b && d[b]();
    });                                                                //
    ...
    var c = !1,                                                        // 10
      ...
      c || a(e).trigger(d.end);                                        // 10
    };return (setTimeout(f, b), this);                                 //
  };var d = b();d && (a.event.special.mmTransitionEnd = { bindType: d.end, delegateType: d.end, handle: function (b) {
    ...
    var c = this.options.activeClass,                                  // 10
        f = a(b),                                                      //
        g = f.parent("li");if (!this.transitioning && !f.hasClass("in")) {
      g.addClass(c), this.options.toggle && this.hide(g.siblings().children("ul.in")), f.removeClass("collapse").addClass("collapsing").height(0), this.transitioning = 1;var h = function () {
    ...
    var c = this.options.activeClass,                                  // 10
      ...
      f.parent("li").removeClass(c), f.height(f.height())[0].offsetHeight, f.addClass("collapsing").removeClass("collapse").removeClass("in"), this.transitioning = 1;var g = function () {
    ...
    return (a.fn.metisMenu = f, this);                                 // 10
  };                                                                   //
})(jQuery);                                                            //
/////////////////////////////////////////////////////////////////////////
