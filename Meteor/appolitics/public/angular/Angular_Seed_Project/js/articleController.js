(function(){
    ...
    function ArticleCtrl($scope, $http, $stateParams, $location) {
        ...
        $scope.loadFeedback = function loadFeedback () {
            var response = $http.get('/election/Meteor/appolitics/public/angular/Angular_Seed_Project/json/user-feedback.json?uuid=' + $stateParams.uuid + '&page=' + $scope.feedBackPageNumber).success(function (data) {
